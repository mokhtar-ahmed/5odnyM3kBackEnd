...
public class User  implements java.io.Serializable {
    ...
    public User(String name, String username, String password, String gender, Date dateOfBirth, String pushNotificationId, String rank, String userImage, String email, String facebookKey, Set joinEvents, Set events, Set phones, Set notifications, Set circles, Set comments, Set existIns) {
       this.name = name;
       this.username = username;
       this.password = password;
       this.gender = gender;
